...
import coChairImg from '../assets/icamse-co-chair.jpg';
                                ...
                                >
                                  ...
                                  <div className="m-speakers-list__items__item__wrapper-one">
                                    ...
                                    >
                                      ...
                                      {speaker.companyLogo && (
                                        <div
                                          className="m-speakers-list__items__item__image__company-logo u-background-color-white"
                                          style={{
                                            position: 'absolute',
                                            bottom: '10px',
                                            right: '10px',
                                        ...
                                        >
                                          <img
                                            className="m-speakers-list__items__item__image__company-logo__image"
                                            alt={`Company logo image for ${speaker.name}`}
                                            loading="lazy"
